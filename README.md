...
- [backend](/backend/README.md#setup)
- [web-app](/web-app/README.md#setup)

## Start

- [devcontainer](/.devcontainer/README.md#start)
- [backend](/backend/README.md#start)
- [web-app](/web-app/README.md#start)
