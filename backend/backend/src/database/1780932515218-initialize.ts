...
export class Initialize1780932515218 implements MigrationInterface {
    name = 'Initialize1780932515218'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "door_block" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "inLandId" uuid, "toLandId" uuid, CONSTRAINT "PK_807d55b046288e491692f3262e2" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "user" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "email" character varying NOT NULL, "passwordHash" character varying NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "isAdmin" boolean NOT NULL DEFAULT false, "appId" uuid NOT NULL DEFAULT uuid_generate_v4(), CONSTRAINT "UQ_e12875dfb3b1d92d7d7c5377e22" UNIQUE ("email"), CONSTRAINT "UQ_0f153cdd5f58aa839137bf5657b" UNIQUE ("appId"), CONSTRAINT "PK_cace4a159ff9f2512dd42373760" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "app_block" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "url" text NOT NULL, "inLandId" uuid, CONSTRAINT "PK_78547aa0c549f1798273bb011cb" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "user_auth_session" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "userId" uuid, CONSTRAINT "PK_f9dcd5312a15fb902dd9f5b055e" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "user_auth_session" ADD CONSTRAINT "FK_10c4d5bf21e3f34543db172bc00" FOREIGN KEY ("userId") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }
