    ...
    */
          function AnimatedTiles(scene, pluginManager) {
            ...
            var _this = _possibleConstructorReturn(
              this,
              (
                AnimatedTiles.__proto__ || Object.getPrototypeOf(AnimatedTiles)
              ).call(this, scene, pluginManager),
            );
          ...
          _createClass(AnimatedTiles, [
            ...
            },
            {
              ...
              value: function resetRates() {
                ...
                if (mapIndex === null) {
                  ...
                  this.animatedTiles[mapIndex].animatedTiles.forEach(function (
                    tileAnimData,
                  ) {
                    tileAnimData.rate = 1;
                  });
            ...
            },
            {
              ...
              value: function resume() {
                ...
                var scope =
                  mapIndex === null ? this : this.animatedTiles[mapIndex];
                if (layerIndex === null) {
                  scope.active = true;
                } else {
                ...
                this.animatedTiles.forEach(function (mapAnimData) {
                  ...
                  mapAnimData.animatedTiles.forEach(function (animatedTile) {
                    ...
                    if (animatedTile.next < 0) {
                      ...
                      animatedTile.next =
                        animatedTile.frames[newIndex].duration;
            ...
            },
            {
              ...
              value: function updateLayer(animatedTile, layer) {
                ...
                var tilesToRemove = [];
                var tileId =
                  animatedTile.frames[animatedTile.currentFrame].tileid;
                layer.forEach(function (tile) {
                  ...
                  if (
                    oldTileId > -1 &&
                    (tile === null || tile.index !== oldTileId)
                  ) {
                    ...
                    tileAnimData.tiles.forEach(function (tiles, layerIndex) {
                      ...
                      for (var _x9 = chkX; _x9 < chkX + chkW; _x9++) {
                        for (var _y = chkY; _y < chkY + chkH; _y++) {
                          var tile =
                            mapAnimData.map.layers[layerIndex].data[_x9][_y];
